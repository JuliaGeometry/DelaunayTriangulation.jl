"""
    clip_polygon(vertices, points, clip_vertices, clip_points; predicates::AbstractPredicateKernel=Adaptive()) -> Vector
...
"""
function clip_polygon(vertices, points, clip_vertices, clip_points; predicates::AbstractPredicateKernel=Adaptive())
...
function clip_polygon(poly::Polygon{T}, clip_poly::Polygon; predicates::AbstractPredicateKernel=Adaptive()) where {T}
    output_list = poly
    q = clip_poly[end]
    for p in clip_poly
