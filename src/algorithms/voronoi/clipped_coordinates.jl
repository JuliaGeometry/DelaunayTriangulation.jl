...
"""
    get_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box=nothing; predicates::AbstractPredicateKernel=def_alg222()) -> Vector{NTuple{2,Number}}
...
"""
function get_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box=nothing; predicates::AbstractPredicateKernel=def_alg222())
...
"""
    clip_bounded_polygon_to_bounding_box(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222()) -> Vector{NTuple{2,Number}}
...
"""
function clip_bounded_polygon_to_bounding_box(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222())
    poly, clip_poly = get_clipping_poly_structs(vorn, i, bounding_box)
    return clip_polygon(poly, clip_poly; predicates)
end

"""
    _get_ray(vorn, i, ghost_vertex, predicates::AbstractPredicateKernel=def_alg222()) -> (Point, Point)
...
"""
function _get_ray(vorn::VoronoiTessellation, i, ghost_vertex, predicates::AbstractPredicateKernel=def_alg222())
...
"""
    grow_polygon_outside_of_box(vorn::VoronoiTessellation, i, bounding_box, predicates::AbstractPredicateKernel=def_alg222()) -> (Vector{Int}, Vector{NTuple{2,Number}})
...
"""
function grow_polygon_outside_of_box(vorn::VoronoiTessellation, i, bounding_box, predicates::AbstractPredicateKernel=def_alg222())
    a, b, c, d = bounding_box
    vertices = get_polygon(vorn, i)
...
"""
    get_bounded_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222()) -> Vector{NTuple{2,Number}}
...
"""
function get_bounded_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222())
    if isnothing(bounding_box)
        C = get_polygon(vorn, i)
        F = number_type(vorn)
...
"""
    get_unbounded_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222()) -> Vector{NTuple{2,Number}}
...
[`Adaptive`](@ref), and [`Fast`](@ref). See the documentation for more information about these choices.
"""
function get_unbounded_polygon_coordinates(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222())
...
[`Adaptive`](@ref), and [`Fast`](@ref). See the documentation for more information about these choices.
"""
function clip_unbounded_polygon_to_bounding_box(vorn::VoronoiTessellation, i, bounding_box; predicates::AbstractPredicateKernel=def_alg222())
