"""
    convex_hull(points; predicates::AbstractPredicateKernel=Adaptive(), IntegerType::Type{I}=Int) where {I} -> ConvexHull 
...
"""
function convex_hull(points; predicates::AbstractPredicateKernel=Adaptive(), IntegerType::Type{I}=Int) where {I}
...
"""
    convex_hull!(ch::ConvexHull{P,I}; predicates::AbstractPredicateKernel=Adaptive()) where {P,I}
...
"""
function convex_hull!(ch::ConvexHull{P,I}; predicates::AbstractPredicateKernel=Adaptive()) where {P,I}
