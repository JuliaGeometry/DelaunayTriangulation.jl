...
"""
    legalise_split_triangle!(tri::Triangulation, i, j, k, r; predicates::AbstractPredicateType=def_alg222())
...
"""
function legalise_split_triangle!(tri::Triangulation, i, j, k, r; predicates::AbstractPredicateType=def_alg222())
...
There is no output, as `tri` is updated in-place.
"""
function complete_split_triangle_and_legalise!(tri::Triangulation, i, j, k, r; predicates::AbstractPredicateType=def_alg222())
