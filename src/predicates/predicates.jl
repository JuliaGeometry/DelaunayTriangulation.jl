@doc """
    triangle_orientation([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, k) -> Certificate 
    triangle_orientation([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, T) -> Certificate
    triangle_orientation([method::AbstractPredicateType=Adaptive(),] p, q, r) -> Certificate
...
"""
    point_position_relative_to_circle([method::AbstractPredicateType=Adaptive(),] a, b, c, p) -> Certificate
...
@doc """
    point_position_relative_to_line([method::AbstractPredicateType=Adaptive(),] a, b, p) -> Certificate
    point_position_relative_to_line([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, u) -> Certificate
...
@doc """
    point_closest_to_line([method::AbstractPredicateType=Adaptive(),] a, b, p, q) -> Certificate
    point_closest_to_line([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, u, v) -> Certificate
...
point_closest_to_line(tri::Triangulation, i, j, u, v) = point_closest_to_line(Adaptive(), i, j, u, v)
...
@doc """
    line_segment_intersection_type([method::AbstractPredicateType=Adaptive(),] p, q, a, b) -> Certificate 
    line_segment_intersection_type([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, u, v, i, j) -> Certificate
...
@doc """
    point_position_relative_to_triangle([method::AbstractPredicateType=Adaptive(),] a, b, c, p) -> Certificate
    point_position_relative_to_triangle([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, k, u) -> Certificate
    point_position_relative_to_triangle([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, T, u) -> Certificate
...
"""
    point_position_relative_to_oriented_outer_halfplane([method::AbstractPredicateType=Adaptive(),] a, b, p) -> Certificate 
...
@doc """
    is_legal([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j) -> Certificate 
    is_legal([method::AbstractPredicateType=Adaptive(),] p, q, r, s) -> Certificate
...
@doc """
    triangle_line_segment_intersection([method::AbstractPredicateType=Adaptive(),] p, q, r, a, b) -> Certificate 
    triangle_line_segment_intersection([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, k, u, v) -> Certificate
...
"""
    find_edge([predicates::AbstractPredicateType=Adaptive(),] tri::Triangulation, T, ℓ) -> Edge 
...
@doc """
    point_position_relative_to_circumcircle([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, k, ℓ) -> Certificate
    point_position_relative_to_circumcircle([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, T, ℓ) -> Certificate
...
"""
    point_position_relative_to_witness_plane([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, i, j, k, ℓ) -> Certificate
...
"""
    opposite_angle([method::AbstractPredicateType=Adaptive(),] p, q, r) -> Certificate
...
"""
    point_position_relative_to_diametral_circle([method::AbstractPredicateType=Adaptive(),] p, q, r) -> Certificate
...
"""
    test_visibility([method::AbstractPredicateType = Adaptive(),] tri::Triangulation, q, i) -> Certificate 
...
# Arguments 
- `method::AbstractPredicateType = Adaptive()`: Method to use for computing predicates. Can be one of [`Fast`](@ref), [`Exact`](@ref) (the default), and [`Adaptive`](@ref). See the documentation for a further discussion of these methods.
...
"""
    test_visibility([method::AbstractPredicateType=Adaptive(),] tri::Triangulation, u, v, i; shift=0.0, attractor=get_point(tri,i)) -> Certificate 
...
# Arguments 
- `method::AbstractPredicateType=Adaptive()`: How predicates are computed. See the documentation for information on the choices between [`Fast`](@ref), [`Exact`](@ref), and [`Adaptive`](@ref).
- `tri`: The [`Triangulation`](@ref).
