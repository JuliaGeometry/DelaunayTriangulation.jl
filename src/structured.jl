"""
    structured_triangulation(a, b, c, d, Nˣ, Nʸ; return_boundary_types = false, single_boundary = false)
...
rather than 4.
"""
function triangulate_structured(a, b, c, d, Nˣ, Nʸ; return_boundary_types=false, single_boundary=false)
    # Connectivity matrix
