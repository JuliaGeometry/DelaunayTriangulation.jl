...
"""
    construct_triangle(tri::Triangulation, i, j, k, predicates::AbstractPredicateKernel=def_alg222()) -> Triangle
...
choices.
"""
function construct_positively_oriented_triangle(tri::Triangulation, i, j, k, predicates::AbstractPredicateKernel=def_alg222()) 
