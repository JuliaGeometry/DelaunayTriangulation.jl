...
"""
    convex_hull!(tri::Triangulation; reconstruct=has_boundary_nodes(tri), predicates::AbstractPredicateKernel=Adaptive())
...
"""
function convex_hull!(tri::Triangulation; reconstruct=has_boundary_nodes(tri), predicates::AbstractPredicateKernel=Adaptive())
    I = integer_type(tri)
    if reconstruct
