...
"""
    convex_hull!(tri::Triangulation; reconstruct=has_boundary_nodes(tri), predicates::AbstractPredicateType=def_alg222())
...
"""
function convex_hull!(tri::Triangulation; reconstruct=has_boundary_nodes(tri), predicates::AbstractPredicateType=def_alg222())
    I = integer_type(tri)
    if reconstruct
