...
@test get_interior_segments(tri) ∈ (Set(((9, 6),)), Set(((6, 9),))) #src
...
s = compute_sum(tri)
@test s ≈ 1.0 + sum(sin(x - y) for (x, y) in ((12, 2), (7, 5), (3, 9), (1, 13))) + cos(0 + 7) #src
...
@test get_adjacent2vertex(tri, -1) == Set(((7, 6),)) #src

#-
get_adjacent2vertex(tri, -2)
@test get_adjacent2vertex(tri, -2) == Set(((10, 9), (8, 7), (11, 10), (9, 8))) #src

#-
get_adjacent2vertex(tri, -3)
@test get_adjacent2vertex(tri, -3) == Set(((6, 11),)) #src
...
s = compute_sum_2(tri)
@test s ≈ sum(sin(x - y) for (x, y) in ((12, 2), (7, 5), (3, 9), (1, 13))) #src
