...
def_adj = DT.DefaultAdjacentValue
default_1 = DefaultDict{NTuple{2,Int64},Int64,Int64}(def_adj)
default_2 = DefaultDict{NTuple{2,Int32},Int32,Int32}(Int32(def_adj))
default_3 = DefaultDict{Vector{Int64},Int64,Int64}(def_adj)

adj_1 = DT.Adjacent{Int64,NTuple{2,Int64}}()
adj_2 = DT.Adjacent{Int32,NTuple{2,Int32}}()
adj_3 = DT.Adjacent{Int64,Vector{Int64}}()
...
dict_1 = Dict((1, 2) => 4, (2, 3) => 10, (5, 6) => 15, (20, 5) => 72)
dict_2 = Dict(@SVector[1, 2] => 4, @SVector[2, 3] => 10, @SVector[5, 6] => 15,
              @SVector[20, 5] => 72)
dict_3 = Dict{NTuple{2,Int32},Int32}((1, 2) => 4, (2, 3) => 10, (5, 6) => 15,
                                     (20, 5) => 72)
ddict_1 = DefaultDict(def_adj, dict_1)
ddict_2 = DefaultDict(def_adj, dict_2)
ddict_3 = DefaultDict(Int32(def_adj), dict_3)
adj_1 = DT.Adjacent(ddict_1)
adj_2 = DT.Adjacent(ddict_2)
adj_3 = DT.Adjacent(ddict_3)
