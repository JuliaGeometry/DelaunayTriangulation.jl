...
@testset "Triangulation getters" begin
    ...
    @test collect(DT.get_positive_curve_indices(hierarchy)) == findall(tri.polygon_hierarchy.polygon_orientations)
    ...
    @inferred DT.get_positive_curve_indices(hierarchy)
