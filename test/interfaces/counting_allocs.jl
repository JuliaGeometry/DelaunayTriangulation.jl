...
save("./docs/src/interface/figs/random.png", fig_random)
save("./docs/src/interface/figs/structured.png", fig_structured)
save("./docs/src/interface/figs/random_cdt.png", fig_random_cdt)
save("./docs/src/interface/figs/structured_cdt.png", fig_structured_cdt)
