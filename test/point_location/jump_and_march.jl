...
@testset "History structure" begin
    history = DT.PointLocationHistory{Set{NTuple{3,Int64}},NTuple{2,Int64},Int64}()
    @test history.triangles == Set{NTuple{3,Int64}}()
    ...
    @test history.triangles == Set{NTuple{3,Int64}}(((2, 3, 4),))
