...
@testset "check_for_intersections_with_adjacent_boundary_edges" begin
      ...
      @testset "Outside" begin
            ...
            i, j, edge_cert, triangle_cert = DT.check_for_intersections_with_interior_edges_adjacent_to_boundary_node(tri, k, q, right_cert, left_cert)
            @test i == index_map["a"] &&
                  j == index_map["t"] &&
      ...
      @testset "Testing for points already on the boundary" begin
            for k in each_point_index(pts)
                  ...
                  if DT.is_outer_boundary_node(tri, k)
                        dir, qp, _k, rc, ℓc = DT.check_for_intersections_with_adjacent_boundary_edges(tri, k, get_point(tri.points, rep, boundary_map, k))
...
@testset "check_for_intersections_with_interior_edges_adjacent_to_boundary_node" begin
      @testset "General" begin
            ...
            i, j, edge_cert, tri_cert = DT.check_for_intersections_with_interior_edges_adjacent_to_boundary_node(tri, k, q, right_cert, left_cert)
            @inferred DT.check_for_intersections_with_interior_edges_adjacent_to_boundary_node(tri, k, q, right_cert, left_cert)
